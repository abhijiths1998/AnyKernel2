cmd_arch/arm64/boot/dts/qcom/beryllium-p0-v2.dtb := mkdir -p arch/arm64/boot/dts/qcom/ ; /home/abhivarma362/disk/clang/bin/clang -E -Wp,-MD,arch/arm64/boot/dts/qcom/.beryllium-p0-v2.dtb.d.pre.tmp -nostdinc -I../arch/arm64/boot/dts -I../arch/arm64/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.beryllium-p0-v2.dtb.dts.tmp ../arch/arm64/boot/dts/qcom/beryllium-p0-v2.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/beryllium-p0-v2.dtb -b 0 -i ../arch/arm64/boot/dts/qcom/ -Wno-unit_address_vs_reg -Wno-unit_address_format -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-gpios_property -Wno-pci_device_reg -d arch/arm64/boot/dts/qcom/.beryllium-p0-v2.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.beryllium-p0-v2.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.beryllium-p0-v2.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.beryllium-p0-v2.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.beryllium-p0-v2.dtb.d

source_arch/arm64/boot/dts/qcom/beryllium-p0-v2.dtb := ../arch/arm64/boot/dts/qcom/beryllium-p0-v2.dts

deps_arch/arm64/boot/dts/qcom/beryllium-p0-v2.dtb := \
...
arch/arm64/boot/dts/qcom/beryllium-p0-v2.dtb: $(deps_arch/arm64/boot/dts/qcom/beryllium-p0-v2.dtb)
